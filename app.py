...
THEMES = {
    ...
    "تم روشن (ساده)": {
        ...
        "--table-header-bg": "#E2E8F0", # Light gray
    ...
    "تم آبی و نارنجی (سفارشی)": {
        "--primary-color": "#007bff",       # Bright Blue (Main)
        "--secondary-color": "#0056b3",     # Darker Blue (Secondary) 
        "--accent-color": "#ffc107",        # Amber/Yellow (Accent/Highlight)
        "--background-color": "#f8f9fa",    # Very Light Grey (Page BG)
        "--container-background-color": "#ffffff", # White (Container BG)
        "--text-color": "#212529",          # Dark Text
        "--header-text-color": "#0056b3",   # Darker Blue for Headers
        "--button-bg-color": "#ffa500",     # Orange (Buttons)
        "--button-hover-bg-color": "#ff8c00", # Darker Orange (Button Hover)
        "--metric-border-accent": "#ffc107", # Amber/Yellow for Metric Accent
        "--table-header-bg": "#007bff",     # Bright Blue for Table Header
        "--tab-active-bg": "#007bff",       # Bright Blue for Active Tab
        "--tab-active-text": "white",
        "--info-bg": "#e6f7ff",            # Light Blue for Info Boxes
        "--info-border": "#007bff",
        "--warning-bg": "#fff3cd",          # Light Yellow for Warning
